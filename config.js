...
global.Owner = {
    ...
    '6287889600100': { // 6287889600100
        name: 'Imannulll store',
...
global.ext = {
	...
	body: 'Imannulll store v2',
	thum: 'https://telegra.ph/file/5859353a380d9b67be198.jpg'
}
global.mods = ['6287889600100'] // Want some help?
global.prems = JSON.parse(fs.readFileSync('./src/premium.json')) // Premium user has unlimited limit
global.DeveloperMode = 'false' // true or false
global.linkGC = ['https://chat.whatsapp.com/LglZYVtwMD85AN2S6OCOo3']
global.packname = 'Imannulll store v2'
global.author = 'Imannulll store'
global.multiplier = 36 // The higher, The harder levelup
global.sessionName = 'nayla' // The Session name behind the .json example is nayla.json
global.mesreport = 50
global.botname = 'Imannulll store v2'
